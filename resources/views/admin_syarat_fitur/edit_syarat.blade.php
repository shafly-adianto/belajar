  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{url('')}}/admin/syarat_fitur/update_syarat/{{$data->id}}/{{$kode}}/{{$kode2}}" method="post">
            {{csrf_field()}}
            <div class="form-group">
              <textarea class="form-control" name="syarat" rows="8" cols="80">{{$data->syarat}}</textarea>
            </div>
